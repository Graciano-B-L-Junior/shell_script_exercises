...
## script1.sh - Interactive Greeting
...
## script2.sh - Directory Existence Checker
...
## script4.sh - File Backup Manager
...
## script7.sh - Directory Backup Automation
...
## script8.sh - Directory Generator
...
### script13.sh - Environment Configuration Check
...
### script14.sh - Service Monitoring Tool
...
### script15.sh - Automated Backup System
...
### script16.sh - GitHub Workflow Validator
...
### script18.sh - System Resource Monitor
This script provides a quick overview of system resources. It checks and displays CPU usage, memory statistics (free/used), disk usage, and the total count of active processes running on the system.
